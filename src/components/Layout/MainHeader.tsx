...
export default function MainHeader() {
  ...
  return <header className="p-2 rounded-md bg-gradient-to-r from-indigo-800 to-indigo-950">
    <div className="flex flex-wrap align-middle justify-center">
      <div className="grid p-4 xs:w-12/12 sm:w-7/12 md:w-5/12 lg:w-6/12 xl:w-7/12">
        <img alt="ds" src="/images/logo.png" width="400" />
      </div>
      <div className='p-4 sm:text-end sm:w-5/12 md:w-7/12 lg:w-6/12 xl:w-5/12'>
        <Link href="/"
          className="inline-flex m-4 text-3xl text-gray-200 hover:text-yellow-500">
